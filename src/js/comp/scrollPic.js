...
//UI&UE Dept. mengjia
//version 1.45
var ScrollPicYHY =function(scrollContId, arrLeftId, arrRightId, dotListId, listType) {
	...
	this.lDiv02 = document.createElement("DIV");
        ...
        this.beforePlayCallback = function(){}
};
ScrollPicYHY.prototype = {
	version: "1.45",
	author: "mengjia",
	pageLength: 0,
	touch: true,
		...
		if (Math.abs(num) == 0) {
			...
			if (this.autoPlay) {
				...
				this.play()
                        ...
                        if(this.ifCallback){
                        this.playCallBack();   
                     //   this.ifCallback = false;//什么时候需要调用callback什么时候开启ifcallback
                        }
			this.accountPageIndex();
			return
		} else {
